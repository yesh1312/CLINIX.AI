...
public class TumorFinding {
    ...
    private String tumorClass;   // e.g. glioma, meningioma, pituitary, notumor, stroke, abscess...
    private String tumorNature;  // e.g. Benign, Malignant, N/A
    ...
    public String getTumorClass() {
        return tumorClass;
    }

    public void setTumorClass(String tumorClass) {
        this.tumorClass = tumorClass;
    }

    public String getTumorNature() {
        return tumorNature;
    }

    public void setTumorNature(String tumorNature) {
        this.tumorNature = tumorNature;
    }
